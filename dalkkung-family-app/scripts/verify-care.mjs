...
const ADMIN = { uid: 'uid-admin', email: 'ku.hayoungkim@gmail.com', password: 'test1234', emailVerified: true, isAdmin: true };
const MEMBER = { uid: 'uid-member', email: 'sibling@example.com', password: 'test1234', emailVerified: true, isAdmin: false };
